...
//    UIBarButtonItem *centerSpace=[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:self action:nil];
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 9.0) {
        if ([UIScreen mainScreen].bounds.size.width == 320) {
            toolbar.items=@[centerSpace,centerSpace,centerSpace,lefttem,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,right,centerSpace];
        } else if ([UIScreen mainScreen].bounds.size.width == 375) {
            toolbar.items=@[centerSpace,centerSpace,lefttem,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,right,centerSpace];
        } else {
            toolbar.items=@[centerSpace,centerSpace,centerSpace,centerSpace,lefttem,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,right];
        }
